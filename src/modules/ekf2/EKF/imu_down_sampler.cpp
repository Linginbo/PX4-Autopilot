...
bool ImuDownSampler::update(const imuSample &imu_sample_new)
{
	...
	_imu_down_sampled.accel_calibration_count = imu_sample_new.accel_calibration_count;
	_imu_down_sampled.gyro_calibration_count = imu_sample_new.gyro_calibration_count;
